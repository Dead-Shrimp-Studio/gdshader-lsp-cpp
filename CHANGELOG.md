...
### Fixed
- Matrix construction always produced error diagnostics: a missing early return in the type checking visitor let every constructor call fall through to the generic "Cannot construct type" error
